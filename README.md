...
2. - [ ] Run `https://github.com/kennedyowusu/to-do-application-webpack.git`
...
Feel free to check the [issues page]((https://github.com/kennedyowusu/to-do-application-webpack/issues)).
